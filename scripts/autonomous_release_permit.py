...
- The trusted model invocation supplies the absolute path to the exact pinned reducer source and tests in the read-only verifier-source directory. Inspect them when the change affects release authority or reducer behavior; do not treat an external commit hash as sufficient evidence by itself.
